/**
 * API Route: LHT Video Upload Metadata Handler
 * 
 * 리팩토링된 구조:
...
export async function POST(request: NextRequest) {
    ...
    // 요청 시작 로깅
    console.log(`[lht-video-upload:${requestId}] START`, {
    ...
    try {
        ...
        try {
            ...
            console.log(`[lht-video-upload:${requestId}] Request body parsed`, {
            ...
            console.error(`[lht-video-upload:${requestId}] JSON parse error:`, {
        ...
        if (!userEmail || !position || !name || !hospital || !videoUrl || !fileName) {
            ...
            console.error(`[lht-video-upload:${requestId}] Missing required fields:`, {
                missingFields,
                received: {
        ...
        if (fileSize && fileSize > 200 * 1024 * 1024) {
            console.error(`[lht-video-upload:${requestId}] File too large:`, {
                fileSize,
        ...
        console.log(`[lht-video-upload:${requestId}] Finding instructors...`, { hospital });
        ...
        try {
            ...
            console.log(`[lht-video-upload:${requestId}] Instructors found`, {
            ...
            console.warn(`[lht-video-upload:${requestId}] Failed to find instructors:`, {
                message: errorMessage,
        ...
        console.log(`[lht-video-upload:${requestId}] Creating log file...`);
        const logFileName = `${position}-${name}-LHT`;
        try {
            ...
            console.log(`[lht-video-upload:${requestId}] Log file created`, {
                logFileName,
                duration: `${logDuration}ms`,
            });
        } catch (logError: any) {
            const errorMessage = extractErrorMessage(logError, 'Failed to create log file');
            console.error(`[lht-video-upload:${requestId}] Failed to create log file:`, {
                message: errorMessage,
        ...
        console.log(`[lht-video-upload:${requestId}] SUCCESS`, {
            videoUrl,
        ...
        console.error(`[lht-video-upload:${errorId}] ERROR:`, {
            message: errorMessage,
            stack: error.stack,
            name: error.name,
            code: error.code,
